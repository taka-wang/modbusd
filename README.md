...
|----------|-----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Travis   | API       | [![Build Status](https://travis-ci.org/taka-wang/modbusd.svg)](https://travis-ci.org/taka-wang/modbusd)                                                         |
| CircleCI | x86       | [![CircleCI](https://circleci.com/gh/taka-wang/modbusd.svg?style=shield)](https://circleci.com/gh/taka-wang/modbusd) |
